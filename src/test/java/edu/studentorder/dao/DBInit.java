...
public class DBInit {
	...
	public static void startUp() throws Exception {
		URL url1 = DirectoryDaoImplTest.class.getClassLoader().getResource("jc_db.sql");
		List<String> str1 = Files.readAllLines(Paths.get(url1.toURI()));
		String sql1 = str1.stream().collect(Collectors.joining());
		
		URL url2 = DirectoryDaoImplTest.class.getClassLoader().getResource("jc_db_values.sql");
